...
import { ThemeSwitcher } from './ThemeSwitcher'; // <--- Importe o novo componente
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <span className="text-3xl"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#821eb8" class="icon icon-tabler icons-tabler-filled icon-tabler-heart">
            ...
            >
              <span className="text-3xl"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#821eb8" class="icon icon-tabler icons-tabler-filled icon-tabler-carambola">
              <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
